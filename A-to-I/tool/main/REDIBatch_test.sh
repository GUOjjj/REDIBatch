...
oganismVersion=( ["human"]="hg19")
# 5.pipeline
#   e.g. echo_preprocess_sh="${projtect_url}/tool/RE/pipeline_redi_test.sh"
preprocess="redi"
echo_preprocess_sh="${projtect_url}/tool/RE/pipeline_redi_test.sh"
##########################################################################################
##########################################################################################
