...
## input content : REDI_table_url,
REDI_table_url, redi_db_url = argv[1],argv[2]
...
outTable_REDI_url= "{REDI_table_url}/second/DnaRna_REDI/outTable_REDI.gz".format(REDI_table_url=REDI_table_url)
# output
## 0_json_dictionary
redi_results_dic_json = "{REDI_table_url}/second/DnaRna_REDI/0_redi_results_dic.json".format(REDI_table_url=REDI_table_url)
## 1_overall_redilevel.txt
overall_redilevel_url = "{REDI_table_url}/second/DnaRna_REDI/1_overall_redilevel.txt".format(REDI_table_url=REDI_table_url)
## 2_known_redi_table.txt
known_redi_table_url = "{REDI_table_url}/second/DnaRna_REDI/2_known_redi_table.txt".format(REDI_table_url=REDI_table_url)
## 3_geneAA_redi_level.txt
geneAA_index_table_url = "{REDI_table_url}/second/DnaRna_REDI/3_geneAA_index_table.txt".format(REDI_table_url=REDI_table_url)
## 4_contribution_type.txt
contribution_type_url = "{REDI_table_url}/second/DnaRna_REDI/4_contribution_type.txt".format(REDI_table_url=REDI_table_url)
## 5_contribution_func.txt
contribution_func_url = "{REDI_table_url}/second/DnaRna_REDI/5_contribution_func.txt".format(REDI_table_url=REDI_table_url)
